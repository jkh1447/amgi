...
public class AddCardPanel extends JPanel {
    ...
    public AddCardPanel(DeckManager deckManager, MainFrame mainFrame, Deck deck, AddCardController addCardController) {
        ...
        JLabel titleLabel = new JLabel(deck.getName());
        ...
        backScroll.setMaximumSize(new Dimension(Integer.MAX_VALUE, 470));
        backScroll.setPreferredSize(new Dimension(Integer.MAX_VALUE, 470));
